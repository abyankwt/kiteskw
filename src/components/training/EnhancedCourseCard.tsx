...
export const EnhancedCourseCard = ({ course, whatsappUrl, index }: CourseCardProps) => {
    ...
    // Simulated recent enrollment count (you can replace with real data)
