...
const Services = () => {
  ...
  return (
    <div ref={containerRef} className="bg-background">
      ...
      {/* Dark Premium Hero */}
      <section className="pt-32 pb-20 lg:pt-48 lg:pb-32 bg-[#0B0F14] relative overflow-hidden">
        ...
        {/* Glow Orb */}
        <div className="absolute top-[-100px] left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-primary/20 blur-[150px] rounded-full pointer-events-none" />
